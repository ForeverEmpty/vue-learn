...
> 状态：已完成。18 项章节测试、复习题和完整回归均已通过。
> 起点记录：4 项通过、14 项失败；完成后为 18 项全部通过。
...
最终验收已经达到 253 项全部通过，TypeScript 与学习门户构建也已通过。[第 21 章复习题](../../review_questions/01-reactivity/21-watch-sources.md) 已完成批改。
