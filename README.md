...
- 最近完成：[第八章：effect 生命周期与 stop](./doc/01-reactivity/08-effect-lifecycle.md)
...
第八章已经完成，当前仍处于响应式模块。后续章节会继续补齐 scheduler、reactive 边界、ref 工具和 watch 完整能力，完成后才进入 runtime 模块。
